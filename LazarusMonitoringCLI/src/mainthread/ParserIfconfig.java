...
public class ParserIfconfig {
    ...
    // This method just scans for new names to put in the name list
    ...
    private Double findBroadcastRate(int rxBytesInt, int txBytesInt, int curTime, String name) {
        ...
        try {
            ...
            // It is too fast so we make it sleep for a while, to increase the
            // chances to find a difference
